...
> 🇬🇧 English (ฉบับหลัก/canonical): [`README.md`](README.md) · repo เฟรมเวิร์ก: [`bemindlabs/BWOC-Framework`](https://github.com/bemindlabs/BWOC-Framework) · v2.42.0 · เอกสารต้นฉบับ (EN/TH): [`docs/`](https://github.com/bemindlabs/BWOC-Framework/tree/main/docs)
