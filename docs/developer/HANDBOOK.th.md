...
> ฉบับภาษาอังกฤษ: [HANDBOOK.en.md](HANDBOOK.en.md) — Framework repo: [bemindlabs/BWOC-Framework](https://github.com/bemindlabs/BWOC-Framework) — v2.24.0 · Rust 1.85+
...
- `crates/` — Rust workspace (เก้า crate ตามที่อธิบายด้านล่าง)
...
workspace มีเก้า crate ซึ่งความสัมพันธ์ dependency ของมันบังคับใช้หลัก quarantine ที่อธิบายใน [หัวข้อ 3](#3-หลักการ-dependency-quarantine) โดย `[workspace.package].version` ปัจจุบันคือ `2.24.0`
